...
module.exports    = function(passport) {
	...
	// passport needs ability to serialize and unserialize users out 
	// of session
	...
	function(req, email, password, done) {
		...
		// asynchronous
		// User.findOne wont fire unless data is send back
		...
		process.nextTick(function(){
			...
			User.findOne({'twitter.id' : profile.id }, function(err, user){
				...
				if(user){
					...
					var newUser = new User();
					console.log('this is tokenSecret: ' + tokenSecret);
